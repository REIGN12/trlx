...
default_config = TRLConfig(
    train=TrainConfig(
        ...
        checkpoint_dir="/root/data/jingchu/trlx_ckps/checkpoints/ppo_hh_gptj-cosine",
    ),
    ...
    scheduler=SchedulerConfig(name="cosine_annealing", kwargs=dict(T_max=10000, eta_min=0.1*8e-6)),
    method=PPOConfig(
        name="PPOConfig",
        num_rollouts=64,
        chunk_size=16,
